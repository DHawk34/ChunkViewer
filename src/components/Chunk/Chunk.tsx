...
export function Chunk(props: Props) {
    ...
    const chunkName_className = chunkNameIsUnsafe(props.chunk.name) && settingsManager.getCache('allowUnsafeChunkNames')
        ? 'chunk_name yellow'
        : 'chunk_name'
            ...
            {(provided) => (
                <div className='chunk' key={props.index}
                    ...
                    <div className='chunk_header'>
                        ...
                        <div className={chunkName_className} onDoubleClick={(e) => spawnInput(e.currentTarget, props.index)}>{props.chunk.name}</div>
                        {
